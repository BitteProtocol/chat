...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bitte-rounded-lg bitte-border bitte-border-border bitte-bg-card bitte-text-card-foreground bitte-shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("bitte-flex bitte-items-center bitte-p-6", className)}
    {...props}
  />
));
