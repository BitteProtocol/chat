...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "bitte-bg-muted/50 bitte-border-t bitte-font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "bitte-hover:bg-muted/50 bitte-border-b bitte-transition-colors data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
